...
- [왜 컨테이너가 필요했을까?](#왜-컨테이너가-필요했을까)
- [컨테이너는 프로세스다](#컨테이너는-프로세스다)
- [격리의 실체: 네임스페이스](#격리의-실체-네임스페이스)
- [자원 제어의 실체: cgroups](#자원-제어의-실체-cgroups)
- [커널 공유의 의미](#커널-공유의-의미)
- [가상 머신과의 구조적 차이](#가상-머신과의-구조적-차이)
- [격리의 한계와 보안 보완](#격리의-한계와-보안-보완)
- [컨테이너의 한계](#컨테이너의-한계)
- [Docker는 컨테이너가 아니다](#docker는-컨테이너가-아니다)
- [정리](#정리)
- [참고 자료](#참고-자료)
